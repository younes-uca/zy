...
import {UserService} from 'src/app/zynerator/security/controller/service/User.service';
...
import {RoleUserService} from 'src/app/zynerator/security/controller/service/RoleUser.service';
...
import {ModelPermissionUserService} from 'src/app/zynerator/security/controller/service/ModelPermissionUser.service';
...
export class UserCreateComponent extends AbstractCreateController<UserDto, UserCriteria, UserService>  implements OnInit {
    ...
    initModelPermissionUser(){
        this.modelPermissionUserService.initModelPermissionUser()
    }
