...
import { MenuService } from 'src/app/menu/app.menu.service';
...
export class AppMainComponent {
  ...
  topbarLangueMenuActive: boolean;

  langueMenuClick: boolean;
  ...
  onTopbarLanguageMenuButtonClick(event) {
    this.langueMenuClick = true;
    this.topbarLangueMenuActive = !this.topbarLangueMenuActive;
  ...
  onLayoutClick() {
    ...
    if (!this.langueMenuClick) {
      this.topbarLangueMenuActive = false;
    }
