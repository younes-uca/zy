...
export class AbstractListController<DTO extends BaseDto, CRITERIA extends BaseCriteria, SERVICE extends AbstractService<DTO, CRITERIA>> {
    ...
    public activateSecurityConstraint(beanName: string){
    ...
    public hasCreateActionPermission(action: string){
        this.service.getModelName(this.beanName);
        const username = this.authService.authenticatedUser.username;
        this.service.hasActionPermission(username, action).subscribe(data => this.createActionIsValid = data  , error => console.log(error) );
    }

    public hasEditeActionPermission(action: string){
        this.service.getModelName(this.beanName);
        const username = this.authService.authenticatedUser.username;
        this.service.hasActionPermission(username, action).subscribe(data => this.editActionIsValid = data  , error => console.log(error) );
    }

    public hasDeleteActionPermission(action: string){
        this.service.getModelName(this.beanName);
        const username = this.authService.authenticatedUser.username;
        this.service.hasActionPermission(username, action).subscribe(data => this.deleteActionIsValid = data  , error => console.log(error) );
    }

    public hasListActionPermission(action: string){
        this.service.getModelName(this.beanName);
        const username = this.authService.authenticatedUser.username;
        this.service.hasActionPermission(username, action).subscribe(data => this.listActionIsValid = data  , error => console.log(error) );
    }

    public hasDuplicateActionPermission(action: string){
        this.service.getModelName(this.beanName);
        const username = this.authService.authenticatedUser.username;
        this.service.hasActionPermission(username, action).subscribe(data => this.duplicateActionIsValid = data  , error => console.log(error) );
    }

    public hasViewActionPermission(action: string){
        this.service.getModelName(this.beanName);
        const username = this.authService.authenticatedUser.username;
        this.service.hasActionPermission(username, action).subscribe(data => this.viewActionIsValid = data  , error => console.log(error) );
    }
