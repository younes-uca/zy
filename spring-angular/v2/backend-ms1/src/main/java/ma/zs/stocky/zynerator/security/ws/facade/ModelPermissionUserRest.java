...
public class ModelPermissionUserRest  extends AbstractController<ModelPermissionUser, ModelPermissionUserDto, ModelPermissionUserCriteria, ModelPermissionUserService, ModelPermissionUserConverter> {
    ...
    @GetMapping("init-ModelPermissionUser")
    public  ResponseEntity<List<ModelPermissionUserDto>> initModelPermissionUser(){
        ...
        List<ModelPermissionUserDto> dtos = new ArrayList();
        ResponseEntity<List<ModelPermissionUserDto>> res = null;
    ...
    @GetMapping("id/{id}")
    public ResponseEntity<ModelPermissionUserDto> findById(@PathVariable Long id, String[] includes, String[] excludes) throws Exception {
