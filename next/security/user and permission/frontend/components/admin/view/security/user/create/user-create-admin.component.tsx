...
const Create: React.FC<UserCreateAdminType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const onBooleanInputChangeModelPermissionUsers = (e: InputSwitchChangeEvent, name: string) => {
       const val = e.value;
            ...
            <TabPanel header={t("user.modelPermissionUsers")}>
                        <div className="grid">
                            ...
                            <div className="field col-5">
                                ...
                                <Dropdown id="actionPermissionDropdown" value={modelPermissionUsers.actionPermission} options={actionPermissions} onChange={(e) => onDropdownChangeModelPermissionUsers(e, 'actionPermission')}    placeholder={t("modelPermissionUser.actionPermissionPlaceHolder")} filter filterPlaceholder={t("modelPermissionUser.actionPermissionPlaceHolderFilter")}  optionLabel="id" showClear />
                             </div>
                            <div className="field col-5">
                                <label htmlFor="modelPermission">{t("modelPermissionUser.modelPermission")}</label>
                                <Dropdown id="modelPermissionDropdown" value={modelPermissionUsers.modelPermission} options={modelPermissions} onChange={(e) => onDropdownChangeModelPermissionUsers(e, 'modelPermission')}    placeholder={t("modelPermissionUser.modelPermissionPlaceHolder")} filter filterPlaceholder={t("modelPermissionUser.modelPermissionPlaceHolderFilter")}  optionLabel="id" showClear />
                             </div>
                    ...
                    <DataTable value={item.modelPermissionUsers} tableStyle={{minWidth: '50rem'}} dataKey="id">
                        ...
                        <Button icon="pi pi-pencil" rounded severity="success" className="mr-2" onClick={()=> editModelPermissionUsers(rowData)} /> </div>)}></Column>
                    </DataTable>
                    </div>
                    </div>
            </TabPanel>
