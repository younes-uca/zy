function fn() {
    ...
    config.adminUri = config.rootUrl + 'api/admin/';
        ...
        config.roleUserUrl = config.adminUri + 'roleUser/';
    config.roleUrl = config.adminUri + 'role/';
    config.modelPermissionUserUrl = config.adminUri + 'modelPermissionUser/';
    config.actionPermissionUrl = config.adminUri + 'actionPermission/';
    config.modelPermissionUrl = config.adminUri + 'modelPermission/';
    config.userUrl = config.adminUri + 'user/';
