...
import Edit from '@/components/admin/view/commun/client/edit/client-edit-admin.component';
import Create from '@/components/admin/view/commun/client/create/client-create-admin.component';
import View from '@/components/admin/view/commun/client/view/client-view-admin.component';
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as ClientDto[])} dataKey="id" className="datatable-responsive" filters={globalFilter} header={header} responsiveLayout="scroll" >
