...
use App\Dao\security\ModelPermissionDao;

class ModelPermissionAdminService
{
    public function __construct(private ModelPermissionDao $dao, )
    {
    }
    ...
    public function update($item, $id)
    {
        ...
        if ($loaded == null) {
            throw new \Exception("ModelPermission not found", 404);
        }
