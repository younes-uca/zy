...
use App\Dao\security\ActionPermissionDao;

class ActionPermissionAdminService
{
    public function __construct(private ActionPermissionDao $dao, )
    {
    }
    ...
    public function update($item, $id)
    {
        ...
        if ($loaded == null) {
            throw new \Exception("ActionPermission not found", 404);
        }
