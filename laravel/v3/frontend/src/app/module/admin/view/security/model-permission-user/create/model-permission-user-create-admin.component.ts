...
@Component({
  selector: 'app-model-permission-user-create-admin',
  templateUrl: './model-permission-user-create-admin.component.html'
})
export class ModelPermissionUserCreateAdminComponent extends AbstractCreateController<ModelPermissionUserDto, ModelPermissionUserCriteria, ModelPermissionUserAdminService>  implements OnInit {
