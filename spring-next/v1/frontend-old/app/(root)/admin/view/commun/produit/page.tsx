...
import View from '@/components/admin/view/commun/produit/view/produit-view-admin.component';
import Create from "@/components/admin/view/commun/produit/create/produit-create-admin.component";
import Edit from "@/components/admin/view/commun/produit/edit/produit-edit-admin.component";
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as ProduitDto[])} dataKey="id" className="datatable-responsive" filters={globalFilter} header={header} responsiveLayout="scroll" >
