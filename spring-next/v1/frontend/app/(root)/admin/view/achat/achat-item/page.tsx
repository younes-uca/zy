...
import {AchatItemAdminService} from '@/controller/service/admin/achat/AchatItemAdminService.service';
...
import View from '@/components/admin/view/achat/achat-item/view/achat-item-view-admin.component';
import Create from "@/components/admin/view/achat/achat-item/create/achat-item-create-admin.component";
import Edit from "@/components/admin/view/achat/achat-item/edit/achat-item-edit-admin.component";
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as AchatItemDto[])} dataKey="id" className="datatable-responsive" filters={globalFilter} header={header} responsiveLayout="scroll" >
