...
import View from '@/components/admin/view/achat/achat/view/achat-view-admin.component';
import Create from "@/components/admin/view/achat/achat/create/achat-create-admin.component";
import Edit from "@/components/admin/view/achat/achat/edit/achat-edit-admin.component";
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as AchatDto[])} dataKey="id" className="datatable-responsive" filters={globalFilter} header={header} responsiveLayout="scroll" >
